...
const ChampionshipBoardBox = () => {
  return (
    <div className="h-[38rem] w-[40rem] border rounded shadow relative">
      ...
      <footer>
        <Column className="pt-4 px-8 text-xs text-gray-500">
      ...
      <div className="absolute h-16 border-t bg-gray-50 inset-x-0 bottom-0">
        <button className="w-full pb-[20px]">
          <Column>
            <Text>O</Text>
