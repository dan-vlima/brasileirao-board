...
const ChampionshipBoardBox = () => {
  return (
    <div className="w-[40rem] border rounded shadow-lg relative">
        <header className="bg-green-800 text-white rounded-t">
          ...
          <Text>Brasileirão Série B</Text>
          </Row>
          <Row className="justify-center text-sm">
          <button className="hover:bg-green-900 h-10 px-7">PARTIDAS</button>
          <button className="hover:bg-green-900 h-10 px-6">NOTÍCIAS</button>
          <button className="hover:bg-green-900 h-10 px-6">CLASSIFICAÇÃO</button>
          <button className="hover:bg-green-900 h-10 px-6">ESTATÍSTICAS</button>
          <button className="hover:bg-green-900 h-10 px-7">JOGADORES</button>
          </Row>
          </Column>
          </header>
          <main>
